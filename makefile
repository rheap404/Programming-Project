...
EXE = ebfEcho ebfComp ebuEcho ebuComp  ebcEcho ebcComp  ebcBlock ebcUnblock
...
ebfEcho: ebfEcho.o ebf.c 
	$(CC) $(CCFLAGS) $^ -o $@

ebfComp: ebfComp.o ebf.c
	$(CC) $(CCFLAGS) $^ -o $@

ebuEcho: ebuEcho.o ebf.c ebu2ebf.c ebf2ebu.c 
	$(CC) $(CCFLAGS) $^ -o $@

ebuComp: ebuComp.o ebf.c ebu2ebf.c 
	$(CC) $(CCFLAGS) $^ -o $@

ebcEcho: ebcEcho.o ebf.c ebc2ebu.c ebu2ebf.c ebf2ebu.c ebu2ebc.c
	$(CC) $(CCFLAGS) $^ -o $@

ebcComp: ebcComp.o ebf.c ebc2ebu.c ebu2ebf.c 
	$(CC) $(CCFLAGS) $^ -o $@


# ebf2ebu: ebf2ebu.o ebf.c
# 	$(CC) $(CCFLAGS) $^ -o $@

# ebu2ebc: ebu2ebc.o ebf.c
# 	$(CC) $(CCFLAGS) $^ -o $@

# ebc2ebu: ebc2ebu.o ebf.c
# 	$(CC) $(CCFLAGS) $^ -o $@

# ebu2ebf: ebu2ebf.o ebf.c
# 	$(CC) $(CCFLAGS) $^ -o $@



ebcBlock: ebcBlock.o ebf.c ebc2ebu.c ebu2ebf.c ebf2ebu.c ebu2ebc.c
	$(CC) $(CCFLAGS) $^ -o $@ -lm

ebcUnblock: ebcUnblock.o ebf.c ebc2ebu.c ebu2ebf.c ebf2ebu.c ebu2ebc.c
	$(CC) $(CCFLAGS) $^ -o $@
